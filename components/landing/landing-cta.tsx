  ...
  return (
    <div className="my-40 flex flex-col items-center gap-6">
      <motion.h1
        ...
        // }}
        // viewport={{ once: true }}
        className="mx-auto max-w-3xl bg-gradient-to-br from-neutral-100 via-neutral-100 via-50% to-neutral-100/30 bg-clip-text py-2 text-center text-5xl leading-relaxed font-medium tracking-tighter text-balance text-transparent md:text-6xl"
      >
      ...
      <motion.p
        ...
        // }}
        // viewport={{ once: true }}
        className="mb-6 max-w-sm bg-gradient-to-br from-white/70 via-white/70 to-white/30 bg-clip-text text-center text-[0.8rem] text-balance text-transparent sm:max-w-[32rem] sm:text-[0.87rem] lg:text-[1rem]"
      >
