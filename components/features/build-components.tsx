  ...
  return (
    <>
      ...
      <motion.h1
        ...
        // }}
        // viewport={{ once: true }}
        className="mx-auto mb-2 max-w-3xl bg-linear-to-br from-neutral-100 via-neutral-100 via-50% to-neutral-100/30 bg-clip-text py-2 text-center text-4xl leading-[1.1] font-medium tracking-tighter text-balance text-transparent md:text-5xl"
      >
      ...
      <motion.p
        ...
        // }}
        // viewport={{ once: true }}
        className="mb-8 max-w-sm bg-linear-to-br from-white/70 via-white/70 to-white/30 bg-clip-text text-center text-[0.8rem] text-balance text-transparent sm:max-w-lg sm:text-[0.87rem] lg:text-[1rem]"
      >
