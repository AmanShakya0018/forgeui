...
const NewNextApp = () => {
  ...
  if (counter > secondPhase) {
    if (counter > secondPhase + 1) {
      elements.push(
        <span key="project-create" className="font-bold">
          ~ Project name
        </span>,
      );
      elements.push(<span key="app-name">| my-app</span>);
    }

    if (counter > secondPhase + 2) {
      elements.push(<span key="open-app">| cd my-app</span>);
      elements.push(
        <span key="install-components" className="font-bold">
    ...
    if (counter > secondPhase + 3) {
      elements.push(<span key="fumadocs">| ✓ forge/ui</span>);
      elements.push(<span key="collections">| ✓ shadcn/ui</span>);
    }
  }
  ...
  return (
    ...
    >
      ...
      <pre className="overflow-hidden rounded-xl border text-[13px] shadow-lg">
        ...
        <div className="min-h-[200px] bg-background dark:bg-gradient-to-b dark:from-neutral-900 dark:to-neutral-950">
