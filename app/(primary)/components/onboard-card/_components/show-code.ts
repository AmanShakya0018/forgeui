...
export const cliscript = "add https://forgeui.amanshakya.in/registry/onboard-card.json";
...
export const democode = `import OnboardCard from '@/components/forgeui/onboard-card';
