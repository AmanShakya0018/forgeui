export const title = "Chromatic Fluid";
export const routepoint = "chromatic-fluid";
...
export const cliscript = "add @forgeui/chromatic-fluid";
...
export const chromaticFluidProps = [
  {
    prop: "height",
    type: "string",
    default: "100vh",
  ...
  },
  {
    ...
    type: "number",
    default: "0.8",
    description: "Controls the fluid flow intensity.",
  },
  {
    prop: "grain",
    type: "number",
  ...
  },
  {
    ...
    type: "number",
    default: "1.1",
    description: "Controls the color contrast.",
  },
  {
    prop: "speed",
    type: "number",
...
export const democode = `import ChromaticFluid from @/components/forgeui/chromatic-fluid;
