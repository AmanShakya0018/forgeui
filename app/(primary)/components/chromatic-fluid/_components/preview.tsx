...
import ChromaticFluid from "./chromatic-fluid";

const ChromaticFluidPage = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={chromaticFluidProps} />
      <ForgeUIProCTA />
...
export default ChromaticFluidPage;

export const LivePreviewChromaticFluidPage = () => {
  return (
