export const title = "Auralis";
export const routepoint = "auralis";
...
export const cliscript = "add @forgeui/auralis";
...
export const auralisProps = [
  ...
  },
  {
    ...
    description: "Array of colors for the glow effect (max 3 colors).",
  },
  {
    prop: "speed",
    type: "number",
...
export const democode = `import Auralis from @/components/forgeui/auralis;
