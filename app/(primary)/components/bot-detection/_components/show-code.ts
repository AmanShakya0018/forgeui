export const title = "Bot Detection";
...
export const cliscript = "add @forgeui/bot-detection";
...
export const botDetectionProps = [
  {
    prop: "cardTitle",
    type: "string",
    default: `"Bot Detection"`,
    description: "The title displayed at the bottom of the detection card.",
  },
  {
    prop: "cardDescription",
    type: "string",
    default: `"Experience fewer fraudulent sign-ups with our sophisticated, AI-driven bot detection that constantly adapts, ensuring high accuracy and efficient platform protection."`,
...
export const democode = `import BotDetection from '@/components/forgeui/bot-detection';
