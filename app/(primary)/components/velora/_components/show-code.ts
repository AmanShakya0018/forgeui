export const title = "Velora";
export const routepoint = "velora";
...
export const cliscript = "add @forgeui/velora";
...
export const veloraProps = [
  ...
  },
  {
    ...
    type: "number",
    default: "1.0",
    description: "Controls the flow intensity.",
  },
  {
    prop: "grain",
    type: "number",
...
export const democode = `import Velora from @/components/forgeui/velora;
