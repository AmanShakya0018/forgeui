...
export const cliscript = "add https://forgeui.amanshakya.in/registry/vault-lock.json";
...
export const vaultLockProps = [
  {
    prop: "cardTitle",
    type: "string",
    default: `"Vault Access"`,
    description: "The title displayed at the bottom of the lock card.",
  },
  {
    prop: "cardDescription",
    type: "string",
    default: `"Smooth and secure login experience, backed by encrypted access and seamless visual transitions"`,
    description: "The description text below the title, summarizing the feature.",
  },
];
export const screennotice = "*Hover to animate"

export const democode = `import VaultLock from '@/components/forgeui/vault-lock';
