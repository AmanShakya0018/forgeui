...
export const cliscript = "add https://forgeui.amanshakya.in/registry/expandable-card.json";
...
export const expandableCardProps = [
  {
    prop: "id",
    type: "string",
    default: "-",
  ...
  },
  {
    ...
    type: "string",
    default: "-",
    description: "Main title of the card (e.g., company name).",
  },
  {
    prop: "subtitle",
    type: "string",
    default: "-",
    description: "Subtitle or position title (e.g., job role).",
  },
  {
    prop: "icon",
    type: "React.ReactNode",
    default: "-",
    description: "JSX element representing the icon (usually an SVG or logo).",
  },
  {
    prop: "description",
    type: "string",
    default: "-",
    description: "Short description, such as salary or summary.",
  },
  {
    prop: "details",
    type: "string",
    default: "-",
    description: "Expanded content shown when the card is expanded.",
  },
  {
    prop: "metadata",
    type: "string",
