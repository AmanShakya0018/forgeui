...
const Test = () => {
  ...
  const democode = `const DummyComponent = () => {
  ...
  return (
    <article className="container lg:pl-8 py-6 max-w-6xl mx-auto">
      ...
      <p className="text-lg mt-0 text-neutral-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore, quia incidunt! Quis, ullam exerci</p>
      ...
      {(!sourceCode) ?
        (<div className="border border-zinc-200 dark:border-zinc-800 px-10 py-12 mt-[2px] bg-transparent rounded-md shadow-md flex justify-center items-center space-x-2 overflow-hidden flex-wrap min-h-[22rem]">
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Culpa et officia ex iste ea? Suscipit, eveniet cumque? Aliquid, blanditiis minus molestiae nisi excepturi sequi praesentium, itaque temporibus, ad rerum pariatur.
        </div>)
        : (<CodeBlock
          language="jsx"
          code={democode}
