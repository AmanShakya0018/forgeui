...
import CosmicRift from "./cosmicrift";

const CosmicriftPage = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={cosmicriftProps} />
      <ForgeUIProCTA />
...
export default CosmicriftPage;

export const LivePreviewCosmicriftPage = () => {
  return (
