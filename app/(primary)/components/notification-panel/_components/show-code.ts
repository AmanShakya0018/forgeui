...
export const notificationPanelProps = [
  {
    prop: "notifications",
    type: "Notification[]",
    default: "defaultNotifications",
    description:
      "Array of notification objects to render inside the panel. Each object in the array must include the following fields:",
  },
  {
  ...
  {
    prop: "notifications[].icon",
    type: "React.ReactNode",
    default: "<FaTools className='h-5 w-5' />",
    description: "Icon component displayed inside the notification card.",
  },
  {
...
import NotificationPanel from '@/components/forgeui/notification-panel';
