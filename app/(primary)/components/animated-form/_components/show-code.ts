...
export const cliscript = "add https://forgeui.amanshakya.in/registry/animated-form.json";
...
export const democode = `import AnimatedForm from '@/components/forgeui/animated-form';
