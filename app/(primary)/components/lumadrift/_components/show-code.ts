export const title = "Luma Drift";
export const routepoint = "lumadrift";
...
export const cliscript = "add @forgeui/lumadrift";
...
export const lumadriftProps = [
  {
    prop: "speed",
    type: "number",
    default: "1",
    description: "Controls the speed of the animated gradient effect.",
  },
  {
    prop: "height",
    type: "string",
    default: "100vh",
    description: "Sets the height of the container element.",
  },
];
export const democode = `import LumaDrift from @/components/forgeui/lumadrift;

export function ${title.replace(/\s+/g, "")}Example() {

  return (
    <LumaDrift speed={1} height="70vh" />
  )
}
`;
