...
const NoctylisPage = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={noctylisProps} />
      <ForgeUIProCTA />
...
export default NoctylisPage;

export const LivePreviewNoctylisPage = () => {
  return (
