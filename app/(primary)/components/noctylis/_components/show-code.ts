export const title = "Noctylis";
export const routepoint = "noctylis";
export const description =
  "A WebGL-powered nocturnal glow background with layered simplex noise, soft violet blooms, and a gentle drifting warp.";

export const cliscript = "add @forgeui/noctylis";
...
export const noctylisProps = [
  {
    prop: "colors",
    type: "string[]",
    default: '["#6b21a8", "#9333ea", "#d8b4fe"]',
    description: "Array of three hex colors for deep base, primary glow, and highlight shimmer.",
  },
  {
    prop: "speed",
    type: "number",
    default: "0.3",
    description: "Controls the animation speed of the glow movement.",
  },
  {
    prop: "grain",
    type: "number",
...
export const democode = `import Noctylis from @/components/forgeui/noctylis;
...
export interface NoctylisProps {
  colors?: string[];
  speed?: number;
  grain?: number;
  height?: string;
...
const DEFAULT_COLORS = ["#6b21a8", "#9333ea", "#d8b4fe"];
...
const Noctylis = ({
  ...
  return (
    <div
      ref={containerRef}
      style={{ height }}
      className={cn("relative w-full overflow-hidden bg-[#0a0510]", className)}
    >
      <canvas
        ref={canvasRef}
