...
const packagescript = "framer-motion clsx tailwind-merge lucide-react react-dropzone";
...
export const democode = `import FileUpload from '@/components/forgeui/file-upload';
