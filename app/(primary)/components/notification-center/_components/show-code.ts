...
export const cliscript = "add https://forgeui.amanshakya.in/registry/notification-center.json";
...
export const notificationCenterProps = [
  {
    prop: "cardTitle",
    type: "string",
    default: `"Real-time payment alerts"`,
    description:
      "The title displayed below the phone, describing the purpose of the notification feature.",
  },
  {
    prop: "cardDescription",
    type: "string",
    default: `"Get instant updates for every successful Stripe transaction processed through your app."`,
    description:
      "A brief explanation shown under the card title to give more context about the notifications.",
  },
  {
    ...
    default: `"Stripe"`,
    description:
      "Title of the notification displayed on the phone screen, typically the sender or service name.",
  },
  {
    prop: "notificationDescription",
    type: "string",
    default: `"You received a payment of $99.00 USD"`,
    description:
      "The body text of the notification, giving more details about the event.",
  },
  {
    ...
    default: `"2h ago"`,
    description:
      "A small timestamp shown alongside the notification, indicating when it occurred.",
  },
];
