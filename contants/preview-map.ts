...
export const previewMap = {
  ...
  "expandable-card": dynamic(() =>
    import("@/app/(primary)/components/expandable-card/_components/preview").then(
      (m) => m.LivePreviewExpandableCard,
    ),
  ),
  "framework-agnostic": dynamic(() =>
    import("@/app/(primary)/components/framework-agnostic/_components/preview").then(
      (m) => m.LivePreviewFrameworkAgnostic,
    ),
  ),
  "fraud-card": dynamic(() =>
  ...
  "notification-center": dynamic(() =>
    import("@/app/(primary)/components/notification-center/_components/preview").then(
      (m) => m.LivePreviewNotificationCenter,
    ),
  ),
  "notification-panel": dynamic(() =>
    import("@/app/(primary)/components/notification-panel/_components/preview").then(
      (m) => m.LivePreviewNotificationPanel,
    ),
  ),
  ...
  "spectrum-switcher": dynamic(() =>
    import("@/app/(primary)/components/spectrum-switcher/_components/preview").then(
      (m) => m.LivePreviewSpectrumSwitcher,
    ),
  ),
  cloudscape: dynamic(() =>
    import("@/app/(primary)/components/cloudscape/_components/preview").then(
